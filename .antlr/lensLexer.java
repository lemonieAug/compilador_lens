...
public class lensLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"START", "END", "LET", "PRINT", "INPUT", "IF", "ELSEIF", "ELSE", "FOR", 
			"WHILE", "IN", "INT_TYPE", "STRING_TYPE", "DUPONT", "POINT2", "DOT2", 
			"VIRG", "EQUALS", "P_N", "P_I", "C_N", "C_I", "MUL", "DIV", "ADD", "SUB", 
			"EQ", "NEQ", "LT", "GT", "LTE", "GTE", "AND", "OR", "STRING", "INT", 
			"VAR", "COMENTARIO", "WS"
		};
	}
	...
	public lensLexer(CharStream input) {
		super(input);
